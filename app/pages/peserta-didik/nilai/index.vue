  ...
  <div class="flex h-screen bg-gray-50 overflow-hidden">
    ...
    <div :class="[
      ...
      <StudentNavbar
        :student="student"
        :is-loading="isLoggingOut"
        page-title="Nilai Peserta Didik"
      ...
      <div class="flex-1 overflow-y-auto overflow-x-hidden w-full">
        <div class="p-6 w-full max-w-full">
          <!-- Header -->
          <div class="mb-6">
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Nilai Peserta Didik</h1>
            <p class="text-sm sm:text-base text-gray-600 mt-1">Lihat nilai dan hasil penilaian pembelajaran</p>
          </div>
          ...
          <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-12">
            <div class="text-center">
              <div class="inline-flex items-center justify-center w-20 h-20 bg-gray-100 rounded-full mb-4">
                <i class="fa-solid fa-file-invoice text-4xl text-gray-400"></i>
              </div>
              <h3 class="text-lg font-semibold text-gray-900 mb-2">Belum Ada Data Nilai</h3>
              <p class="text-gray-600 max-w-md mx-auto">
                Informasi nilai dan hasil penilaian akan ditampilkan di sini.
              </p>
            </div>
          </div>
        </div>
...
useHead({
  title: 'Nilai Peserta Didik | Portal Peserta Didik',
  link: [
    {
      rel: 'icon',
      type: 'image/jpeg',
