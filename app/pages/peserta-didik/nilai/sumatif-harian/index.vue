  ...
  <div class="flex h-screen bg-gray-50 overflow-hidden">
    ...
    <div :class="[
      ...
      <StudentNavbar
        :student="student"
        :is-loading="isLoggingOut"
        page-title="Nilai Sumatif Harian"
      ...
      <div class="flex-1 overflow-y-auto overflow-x-hidden w-full">
        <div class="p-6 w-full max-w-full">
          <div class="mb-6">
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Nilai Sumatif Harian</h1>
            <p class="text-sm sm:text-base text-gray-600 mt-1">Lihat nilai penilaian sumatif harian Anda</p>
          </div>
          ...
          <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-12">
            <div class="text-center">
              ...
              <h3 class="text-lg font-semibold text-gray-900 mb-2">Belum Ada Data Nilai Sumatif Harian</h3>
              <p class="text-gray-600 max-w-md mx-auto">
                Informasi nilai sumatif harian akan ditampilkan di sini.
              </p>
            </div>
          </div>
        </div>
...
useHead({
  title: 'Nilai Sumatif Harian | Portal Peserta Didik',
