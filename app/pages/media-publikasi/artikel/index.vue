      ...
      <div class="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-md p-4 sm:p-6 mb-8">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label class="block text-sm font-semibold text-gray-700 mb-2">
                <i class="fas fa-filter mr-2 text-red-600"></i>Kategori
              </label>
              <select 
        ...
        <!-- Loading State -->
        <div v-if="loading && artikelList.length === 0" class="text-center py-12">
          <i class="fas fa-spinner fa-spin text-4xl text-red-600 mb-4"></i>
          <p class="text-gray-600">Memuat artikel...</p>
        </div>

        <!-- Article Grid -->
        <div v-else-if="artikelList.length > 0" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <div 
          ...
          >
            ...
            <div class="relative h-48 overflow-hidden">
              ...
              <!-- Category Badge -->
              <span class="absolute top-3 right-3 px-3 py-1 rounded-full text-xs font-bold text-white shadow-lg" style="background: linear-gradient(135deg, #8B0000, #DC143C);">
            ...
            <div class="p-5">
              ...
              <!-- Description -->
              <p class="text-sm text-gray-600 line-clamp-3 leading-relaxed mb-4" v-html="stripHtml(artikel.deskripsi)"></p>
        ...
        <!-- Loading More -->
        <div v-if="loading && artikelList.length > 0" class="text-center py-6">
...
// Fetch articles
const fetchArtikel = async (append = false) => {
  loading.value = true
...
// Go to detail
const goToDetail = (id) => {
  router.push(`/media-publikasi/artikel/${id}`)
}
