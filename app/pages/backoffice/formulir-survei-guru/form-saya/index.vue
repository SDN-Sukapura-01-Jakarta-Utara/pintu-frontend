      ...
      <div class="flex items-center justify-between gap-3 sm:gap-4 flex-wrap">
        <div>
          ...
          <p class="text-[13px] sm:text-sm md:text-[15px] text-gray-600 mt-1 sm:mt-2">
            Kelola formulir dan survei yang Anda buat
          </p>
        </div>
        <button
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div v-else class="flex flex-col items-center justify-center py-16">
        ...
        <p class="text-gray-600 text-center max-w-md">
          Belum ada formulir yang Anda buat. Klik tombol "Buat Formulir/Survei" untuk membuat formulir baru.
        </p>
      </div>
    </div>
  </DashboardLayout>
...
useHead({
  title: 'Form & Survei Saya | Backoffice',
})
...
const openCreateModal = () => {
  navigateTo('/backoffice/formulir-survei-guru/create-formulir')
}
