            ...
            <div
                ...
                <div
                    ...
                    <div class="relative z-10 flex-1">
                        <h2 class="text-lg sm:text-xl font-bold text-white">Tambah Tenaga Kependidikan</h2>
                    </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div>
                                ...
                                <input v-model="form.nip" type="text" placeholder="Nomor Induk Pegawai"
                                    :disabled="isSubmitting || form.isHonorer || (form.nkki.trim().length > 0)"
                            ...
                            <div>
                                ...
                                <input v-model="form.nkki" type="text" placeholder="Nomor KKI"
                                    :disabled="isSubmitting || form.isHonorer || (form.nip.trim().length > 0)"
...
const handleSubmit = async () => {
    ...
    if (form.value.passwordType === 'auto') {
        if (!autoGeneratedPassword.value) {
            if (form.value.isHonorer) {
                toastStore.showToast('error', 'Gagal menyimpan', 'Masukkan username terlebih dahulu')
            } else {
