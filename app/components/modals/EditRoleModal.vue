        ...
        <div v-if="modelValue"
            ...
            <div
                ...
                <div
                    ...
                    <!-- Close Button -->
                    <button type="button" @click.stop="closeModal" :disabled="isSubmitting || isLoading"
                        :title="'Tutup'"
                ...
                <div class="p-4 sm:p-8 relative z-10 overflow-y-auto flex-1">
                    ...
                    <form v-else @submit.prevent="handleSubmit" class="space-y-4 sm:space-y-6">
                        ...
                        <div>
                            ...
                            <select v-else v-model.number="form.system_id" required :disabled="isSubmitting"
...
import type { SystemData, UpdateRoleRequest } from '~/types/RoleType'
