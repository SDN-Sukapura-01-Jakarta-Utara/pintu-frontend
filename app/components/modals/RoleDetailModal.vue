      ...
      <div
        ...
        <div class="p-3 sm:p-5 md:p-8 relative z-10 overflow-y-auto flex-1">
          ...
          <div v-else-if="roleDetail" class="space-y-6">
            ...
            <div
              class="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg sm:rounded-xl border-2 border-blue-200 p-3 sm:p-4 md:p-6">
            ...
            <div class="bg-white rounded-lg sm:rounded-xl border-2 border-gray-200">
              ...
              <div class="p-3 sm:p-4 md:p-6">
                <p class="text-xs sm:text-sm text-gray-700 leading-relaxed whitespace-pre-wrap break-words">
              ...
              <div class="p-3 sm:p-4 md:p-6">
                <div class="flex items-start gap-3 sm:gap-4 p-2 sm:p-3 bg-gray-50 rounded-lg">
                  ...
                  <div class="flex-1 min-w-0">
                    <p class="text-xs sm:text-sm font-bold text-gray-900">{{ roleDetail.system?.nama || '-' }}</p>
