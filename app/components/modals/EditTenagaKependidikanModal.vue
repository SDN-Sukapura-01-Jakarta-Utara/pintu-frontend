...
const loadFormData = () => {
    ...
    const nipEmpty = !props.tenagaKependidikan.nip || props.tenagaKependidikan.nip.trim() === ''
    const nkkiEmpty = !props.tenagaKependidikan.nkki || props.tenagaKependidikan.nkki.trim() === ''
    ...
    form.value = {
        ...
        isHonorer: autoCheckHonorer ? true : (props.tenagaKependidikan.is_honorer || false),
...
const handleSubmit = async () => {
    ...
    // Validate NIP or NKKI - at least one must be filled (unless honorer)
