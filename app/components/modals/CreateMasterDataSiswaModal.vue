            ...
            <div
                ...
                <div
                    ...
                    <div class="relative z-10 flex-1">
                        <h2 class="text-lg sm:text-xl font-bold text-white">Tambah Data Siswa</h2>
                    </div>
...
const handleSubmit = async () => {
    ...
    try {
        ...
        const response = await $fetch(`${config.public.apiBase}/api/v1/peserta-didik/create-peserta-didik`, {
            method: 'POST',
            headers: {
        ...
        toastStore.success('Sukses', 'Data siswa berhasil ditambahkan')
        closeModal()
        emit('success')
    } catch (error: any) {
