            ...
            <div
                ...
                <div class="p-4 sm:p-6">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <!-- Title -->
                        <h3 class="text-base sm:text-lg font-bold text-gray-900 mb-2">Hapus Data Siswa</h3>

                        <!-- Message -->
                        <p class="text-xs sm:text-sm text-gray-600 mb-4 sm:mb-6">
                            Apakah Anda yakin ingin menghapus data siswa <span class="font-semibold">'{{ siswaName }}'</span>?
                            <br>
...
const handleConfirm = async () => {
    ...
    try {
        await $fetch(`${config.public.apiBase}/api/v1/peserta-didik/delete-peserta-didik`, {
            method: 'POST',
            headers: {
        ...
        toastStore.success('Sukses', 'Data siswa berhasil dihapus')
        ...
        const errorMessage = error?.data?.message || error?.message || 'Gagal menghapus data siswa'
