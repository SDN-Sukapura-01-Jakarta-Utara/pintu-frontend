    ...
    >
        ...
        <div class="sticky top-0 bg-red-800 border-b border-red-700 w-full"
            ...
            <div class="flex flex-col items-center"
                :class="isOpen ? 'gap-4' : 'gap-0'">
                <!-- Logo Sekolah -->
                <img src="~/assets/images/logo-sekolah.jpg" alt="Logo SDN Sukapura 01"
                    :class="[
        ...
        <nav class="flex-1 w-full"
            ...
            <!-- Informasi Sekolah -->
            <div>
                <button @click="toggleSubmenu('sekolah')"
                    :class="[
                ...
                <!-- Submenu -->
                <div v-if="isOpen && openMenus.sekolah"
                    class="ml-12 mt-2 space-y-2 border-l border-red-500 pl-4">
                    <NuxtLink to="/backoffice/informasi-sekolah/jumbotron"
                        class="block text-sm py-2 px-2 rounded transition-all duration-200 hover:bg-red-700">
                        Jumbotron
                    </NuxtLink>
                    <NuxtLink to="/backoffice/informasi-sekolah/kutipan"
                        class="block text-sm py-2 px-2 rounded transition-all duration-200 hover:bg-red-700">
                        Kutipan Kepala Sekolah
                    </NuxtLink>
                    <NuxtLink to="/backoffice/informasi-sekolah/visi-misi"
                        class="block text-sm py-2 px-2 rounded transition-all duration-200 hover:bg-red-700">
                        Visi Misi
                    </NuxtLink>
                    <NuxtLink to="/backoffice/informasi-sekolah/sarana-prasarana"
                        class="block text-sm py-2 px-2 rounded transition-all duration-200 hover:bg-red-700">
                        Sarana & Prasarana
                    </NuxtLink>
                    <NuxtLink to="/backoffice/informasi-sekolah/struktur"
                        class="block text-sm py-2 px-2 rounded transition-all duration-200 hover:bg-red-700">
                        Struktur Organisasi
                    </NuxtLink>
                </div>
            ...
            <!-- Media dan Publikasi -->
            <div>
                <button @click="toggleSubmenu('media')"
                    :class="[
                        'w-full flex items-center rounded-lg transition-all duration-200 hover:bg-red-700',
                        isOpen ? 'gap-4 px-4 py-3' : 'gap-0 justify-center px-2 py-3'
                    ]">
                ...
                <!-- Submenu -->
                <div v-if="isOpen && openMenus.media"
                    class="ml-12 mt-2 space-y-2 border-l border-red-500 pl-4">
            ...
            <!-- Peserta Didik -->
            <NuxtLink to="/backoffice/peserta-didik"
                :class="[
            ...
            <!-- Kepegawaian -->
            <div>
                <button @click="toggleSubmenu('kepegawaian')"
                    :class="[
                        'w-full flex items-center rounded-lg transition-all duration-200 hover:bg-red-700',
                        isOpen ? 'gap-4 px-4 py-3' : 'gap-0 justify-center px-2 py-3'
                    ]">
            ...
            <!-- Mutasi Siswa -->
            <NuxtLink to="/backoffice/mutasi-siswa"
                :class="[
                    'flex items-center rounded-lg transition-all duration-200 hover:bg-red-700',
                    isOpen ? 'gap-4 px-4 py-3' : 'gap-0 justify-center px-2 py-3'
                ]">
            ...
            <div>
                <button @click="toggleSubmenu('pertanyaan')"
                    :class="[
                        'w-full flex items-center rounded-lg transition-all duration-200 hover:bg-red-700',
                        isOpen ? 'gap-4 px-4 py-3' : 'gap-0 justify-center px-2 py-3'
                    ]">
